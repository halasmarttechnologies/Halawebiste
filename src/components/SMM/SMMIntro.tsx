    ...
    <div id="intro" className="w-full">
      ...
      <section className="relative bg-[#111111] z-20 pt-16 pb-20 md:pt-24 md:pb-28 px-4 sm:px-6 lg:px-8 flex flex-col items-center border-b border-[#222222] overflow-hidden">
        <div className="max-w-[900px] text-center relative z-20">
          ...
          <h2 className="font-poppins font-semibold text-3xl sm:text-4xl md:text-5xl lg:text-[52px] text-white leading-tight mb-8">
            Build Connections with <em className="eb-garamond font-normal italic">Social Media</em>
          </h2>

          <p className="font-poppins text-base sm:text-lg md:text-xl lg:text-2xl leading-[1.7] mb-10 text-[#E8E6E1] font-normal max-w-[860px] mx-auto">
