      ...
      <div className="max-w-[1280px] mx-auto relative z-10">
        ...
        <div className="flex flex-col items-center justify-center text-center mb-16 md:mb-20">
          ...
          <h2 className="font-poppins font-semibold text-3xl sm:text-5xl md:text-6xl lg:text-[4.2rem] leading-[1.08] tracking-tight mb-6 text-[#111111] max-w-4xl">
            Explore Our <em className="eb-garamond font-normal italic pr-2">all-in-One Services</em>
          </h2>
                        ...
                        >
                          ...
                          <div className="flex items-center justify-between w-full focus:outline-none">
                            <div className="flex items-center gap-3.5">
                              ...
                              <span className={`font-poppins text-base font-semibold ${isActive ? 'text-white' : 'text-[#111111]'
                                }`}>
                                {service.title}
                              </span>
                            </div>
                            ...
                            {isActive && (
                              ...
                              >
                                <div className="pt-4 pb-2 pl-12">
                                  <p className="font-poppins text-xs md:text-sm leading-relaxed text-[#CCCCCC] font-normal">
                                    {service.description}
                                  </p>
                                </div>
                              </motion.div>
