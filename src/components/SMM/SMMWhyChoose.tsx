...
import { LayoutDashboard, HeartHandshake, Target, BarChart2, Users } from 'lucide-react';

const smmPillars = [
  {
    id: 1,
    title: 'Customized Strategies',
    description: 'We design tailored strategies based on what your audience responds to and what your business truly needs.',
  ...
  },
  {
    ...
    description: 'Consistent, customized content and high-quality visuals that perfectly match your brand identity.',
    icon: HeartHandshake,
  ...
  },
  {
    ...
    description: 'From active community engagement to targeted ads, everything we do is built to deliver real growth.',
    icon: Target,
  ...
  },
  {
    ...
    description: 'Our reporting is transparent, easy to understand, and completely result-focused so you always know what works.',
    icon: BarChart2,
  ...
  },
  {
    ...
    description: 'You get more than just marketing; you get a committed partner dedicated to helping your brand stand out.',
    icon: Users,
...
export default function SMMWhyChoose() {
  return (
    <section className="w-full bg-white text-[#111111] py-16 md:py-24 px-4 sm:px-6 md:px-8 lg:px-12 relative overflow-hidden border-b border-[#e5e5e5]">
      <div className="max-w-[1280px] mx-auto flex flex-col items-center">
        ...
        <p className="font-poppins text-base md:text-lg text-[#555555] text-center max-w-3xl mb-14 -mt-6">
          We’re not just here to post, we’re here to grow your brand. At Hala Technology, we design strategies based on what your audience responds to and what your business truly needs.
        </p>

        {/* 5-Column Gradient Box Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 w-full">
          {smmPillars.map((pillar) => {
