...
const AuditMockup = memo(function AuditMockup() {
  return (
...
const StrategyMockup = memo(function StrategyMockup() {
  return (
    <div className="flex flex-col space-y-3">
      <div className="flex items-center justify-between border-b border-gray-100 pb-2">
        <span className="text-xs font-bold text-[#111111] flex items-center gap-2">
...
const ExecutionMockup = memo(function ExecutionMockup() {
  return (
    <div className="flex flex-col space-y-3">
      <div className="flex items-center justify-between border-b border-gray-100 pb-2">
        <span className="text-xs font-bold text-[#111111] flex items-center gap-2">
...
const OptimizationMockup = memo(function OptimizationMockup() {
  return (
    <div className="flex flex-col space-y-3">
      <div className="flex items-center justify-between border-b border-gray-100 pb-2">
        <span className="text-xs font-bold text-[#111111] flex items-center gap-2">
...
const ScaleMockup = memo(function ScaleMockup() {
  return (
    <div className="flex flex-col space-y-3">
      <div className="flex items-center justify-between border-b border-gray-100 pb-2">
        <span className="text-xs font-bold text-[#111111] flex items-center gap-2">
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <div className="bg-[#FAFAFA] p-3 rounded-lg border border-gray-200">
...
const WORKFLOW_STEPS = [
  ...
  },
  {
    ...
    MockupComponent: StrategyMockup,
  },
  {
    id: 'execution',
    step: '03',
    ...
    MockupComponent: ExecutionMockup,
  },
  {
    id: 'optimization',
    step: '04',
    ...
    MockupComponent: OptimizationMockup,
  },
  {
    id: 'scale',
    step: '05',
            ...
            <div className="md:col-span-7 bg-white rounded-2xl border border-[#E5E7EB] p-6 lg:p-8 flex flex-col justify-between shadow-xs relative overflow-hidden">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  {/* Step Display Card */}
                  <div className="w-full bg-[#FAFAFA] rounded-xl border border-[#E5E7EB] p-4 lg:p-6 overflow-hidden">
                    <activeStepObj.MockupComponent />
                  </div>
                </motion.div>
              </AnimatePresence>
            </div>
                  ...
                  <AnimatePresence>
                    {isActive && (
                      ...
                      >
                        ...
                        <div className="bg-[#FAFAFA] rounded-xl border border-[#E5E7EB] p-3 overflow-hidden">
