...
export default function BrandingHeroSection() {
  ...
  return (
    <div className="relative w-full bg-[#111111] text-[#F3F0E6] overflow-x-hidden antialiased selection:bg-[#EADCF8] selection:text-[#111]">
      ...
      {/* ─────────────────── HERO SECTION ─────────────────── */}
      <section className="relative z-0 flex flex-col items-center justify-start w-full min-h-[calc(100svh+32px)] md:min-h-[calc(100svh+40px)] overflow-hidden gpu-layer">
        ...
        <div className="absolute bottom-16 sm:bottom-20 lg:bottom-24 right-5 sm:right-8 lg:right-16 z-20 flex gap-4 sm:gap-5 text-white/30">
