...
const seoPillars = [
  {
    ...
    description: 'Tailored search engine optimization strategies built around your exact business objectives and audience.',
  ...
  },
  {
    ...
    description: 'Fusing data-driven insights with creative execution for maximum search visibility and conversions.',
    icon: TrendingUp,
  ...
  },
  {
    ...
    description: 'Demonstrated regional expertise tuned specifically to regional UAE search intent and competitive niches.',
    icon: Target,
  ...
  },
  {
    ...
    description: 'Converting organic search traffic directly into qualified leads, customer inquiries, and revenue.',
    icon: Eye,
  ...
  },
  {
    ...
    description: 'Clear, continuous reporting keeping you informed and ahead of search engine competitors at every stage.',
    icon: Award,
