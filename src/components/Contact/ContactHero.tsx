  ...
  return (
    <section className="relative w-full pt-[140px] pb-16 md:pt-[180px] md:pb-24 bg-white border-b border-[#e5e5e5]">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-start">
        ...
        <h1 className="font-poppins text-4xl sm:text-6xl md:text-7xl lg:text-[84px] font-semibold text-[#111111] leading-[1.05] tracking-tight mb-8 max-w-[1050px]">
          Let’s build something <em className="eb-garamond font-normal italic">extraordinary</em> together.
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 w-full pt-8 border-t border-[#f0f0f0]">
          ...
          <div className="md:col-span-5 lg:col-span-4 flex flex-col justify-between items-start md:items-end gap-3">
            <div className="flex flex-col items-start md:items-end">
              ...
              <span className="font-poppins text-sm font-medium text-[#111111] flex items-center gap-1.5 text-right">
            ...
            <div className="flex flex-col items-start md:items-end">
              ...
              <span className="font-poppins text-sm font-medium text-[#111111] flex items-center gap-1.5">
