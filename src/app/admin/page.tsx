...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-8">
      {/* Top Banner / Welcome */}
      <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-blue-950 rounded-2xl p-6 md:p-8 text-white shadow-md relative overflow-hidden">
        <div className="relative z-10 max-w-2xl space-y-3">
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            <Link
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold bg-[#007FFF] text-white hover:bg-blue-600 transition-all shadow-md shadow-blue-500/20"
            >
              <Plus className="w-4 h-4" /> Create & Upload New Blog
            </Link>
            <Link
              href="/admin/sections"
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold bg-white/10 hover:bg-white/20 text-white transition-all border border-white/10"
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex items-center justify-between">
          <div>
            ...
            <h3 className="text-2xl font-bold text-slate-900">{blogs.length}</h3>
            <p className="text-[11px] text-slate-500 mt-1">Available in database</p>
          </div>
          <div className="w-12 h-12 rounded-xl bg-blue-50 text-[#007FFF] flex items-center justify-center font-bold">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex items-center justify-between">
          <div>
            ...
            <h3 className="text-2xl font-bold text-emerald-600">{publishedBlogs.length}</h3>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex items-center justify-between">
          <div>
            ...
            <h3 className="text-2xl font-bold text-amber-600">{homepageBlogs.length}</h3>
            <p className="text-[11px] text-slate-500 mt-1">Pinned to homepage section</p>
          </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex items-center justify-between">
          <div>
            ...
            <h3 className="text-2xl font-bold text-slate-600">{draftBlogs.length}</h3>
            <p className="text-[11px] text-slate-500 mt-1">Work in progress</p>
          </div>
              ...
              <div key={blog.id} className="border border-slate-200 rounded-xl p-4 bg-slate-50/50 flex flex-col justify-between space-y-3">
                ...
                <div className="flex items-center justify-between pt-2 border-t border-slate-200/60">
                  <button
                    ...
                    className="text-xs font-semibold text-amber-700 bg-amber-100 hover:bg-amber-200 px-2.5 py-1 rounded-lg transition-colors flex items-center gap-1"
                  >
